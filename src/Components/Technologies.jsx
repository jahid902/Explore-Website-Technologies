  ...
  return (
    <>
      ...
      <div className="text-center w-full md:w-3/4 mx-auto space-y-3 mb-4 md:mb-12">
        ...
        <p className="text-lg ">
          These are the Technical Tools that help build a website. They make the work easy as well 
          audience appealing. 
        </p>
      </div>
        <div
          ...
          {techs.slice(0, show ? 25 : 9).map((tech) => (
              ...
              >
                ...
                <div className="bg-sky-900 px-6 py-4 bg-opacity-80 opacity-0 hover:opacity-100 text-white text-center absolute inset-0 transition-opacity duration-500 flex flex-col justify-center">
                  ...
                  <br />
                  <Link to={`/tech/${tech.id}`}><button className="btn-common my-auto">See Details</button></Link>
                </div>
              </div>
      ...
      <button onClick={()=> setShow(!show)} className="btn-common mt-24 flex mx-auto">{show ? "See Less" : "See More"}</button>
    </>
  );
};
