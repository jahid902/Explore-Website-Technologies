    ...
    <section className="flex flex-col-reverse md:grid grid-cols-2 lg:grid-flow-col-2 gap-10 md:gap-3 py-6 px-2 md:pt-20 md:pb-8 md:px-10">
      <div className="font-serif space-y-6 text-center md:text-start  md:order-first md:p-6">
        ...
        <p>
          ...
          Technologies. Our Expert Team Empowers You to Stand Out in the Digital
          Landscape, Creating Sleek Designs, Seamless Functionality, and
          Unforgettable User Experiences. Embrace the Future of Web Development
          and Unlock Limitless Possibilities for Your Business.
        </p>
        <button className="btn-common">Explore</button>
      </div>
